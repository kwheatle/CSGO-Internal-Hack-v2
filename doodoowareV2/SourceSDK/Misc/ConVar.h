...
public:
	...
	void SetValue(const char* value)
	{
		...
		return gInterface.CallVirtualFunction<void>(this, 14, value);
	}
	void SetValueStr(const char* str)
	{
		//typedef void(__thiscall* SetStringFn)(void*, const char*);
		return gInterface.CallVirtualFunction<void>(this, 13, str);
	}
	void SetValue(int value)
	{
		//typedef void(__thiscall* OriginalFn)(void*, int);
		return gInterface.CallVirtualFunction<void>(this, 16, value);
	}
	void SetValueChar(const char* name)
	{
		typedef void(__thiscall* SetNameFN)(void*, const char*);
		return gInterface.CallVirtualFunction<void>(this, 14 , name);
	}
	void InternalSetString(const char* str)
	{
		typedef void(__thiscall* SetStringFn)(void*, const char*);
		return gInterface.CallVirtualFunction<void>(this, 17 , str);
	}
	char* GetBaseName()
	{
		//typedef char*(__thiscall* SetStringFn)(void*);
		return gInterface.CallVirtualFunction<char*>(this, 6 );
	}
	float GetFloat()
	{
		//typedef float(__thiscall* SetValueFn)(void*);
		return gInterface.CallVirtualFunction< float >(this, 12 );
	}

	int GetInt()
	{
		//typedef float(__thiscall* SetValueFn)(void*);
		return gInterface.CallVirtualFunction< int >(this, 13);
	}
...
public:
	ConVar*	FindVar(const char *var)
	{
		...
		return gInterface.CallVirtualFunction<ConVar*>(this, 15, var);
	}
};
