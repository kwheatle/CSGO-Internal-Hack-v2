...
public:
	void setBlend(float blend) {
		gInterface.CallVirtualFunction< void(__thiscall *)(decltype(this), float) >(this, 4)(this, blend);
	}

	void SetColorModulation(float *col) {
		gInterface.CallVirtualFunction< void(__thiscall*)(void *, const float *) >(this, 6)(this, col);
	}
};*/
