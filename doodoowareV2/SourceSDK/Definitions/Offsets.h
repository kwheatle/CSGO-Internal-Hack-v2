...
namespace Offsets
{
	...
	const DWORD m_angEyeAnglesX = 0xB344;
	const DWORD m_angEyeAnglesY = 0xB348;
	...
	const DWORD m_flLowerBodyYawTarget = 0x3A78;
	...
	const DWORD dwClientState = 0x58CCFC;
	...
	const DWORD dwEntityList = 0x4D04B04;
	const DWORD dwForceAttack = 0x31361C0;
	const DWORD dwForceAttack2 = 0x31361CC;
	const DWORD dwForceBackward = 0x3136208;
	const DWORD dwForceForward = 0x3136214;
	const DWORD dwForceJump = 0x51A81BC;
	const DWORD dwForceLeft = 0x313622C;
	const DWORD dwForceRight = 0x3136220;
	const DWORD dwGameDir = 0x632F70;
	const DWORD dwGameRulesProxy = 0x521A504;
	const DWORD dwGetAllClasses = 0xD1795C;
	const DWORD dwGlobalVars = 0x58CA00;
	const DWORD dwGlowObjectManager = 0x5245018;
	const DWORD dwInput = 0x514FB50;
	const DWORD dwInterfaceLinkList = 0x8C7E94;
	const DWORD dwLocalPlayer = 0xCF2A3C;
	const DWORD dwMouseEnable = 0xCF8588;
	const DWORD dwMouseEnablePtr = 0xCF8558;
	const DWORD dwPlayerResource = 0x313454C;
	const DWORD dwRadarBase = 0x5139864;
	const DWORD dwSensitivity = 0xCF8424;
	const DWORD dwSensitivityPtr = 0xCF83F8;
	const DWORD dwSetClanTag = 0x896A0;
	const DWORD dwViewMatrix = 0x4CF6534;
	const DWORD dwWeaponTable = 0x5150614;
	const DWORD dwWeaponTableIndex = 0x323C;
	const DWORD dwYawPtr = 0xCF81E8;
	const DWORD dwZoomSensitivityRatioPtr = 0xCFD408;
	const DWORD dwbSendPackets = 0xD286A;
	const DWORD dwppDirect3DDevice9 = 0xA6030;
	const DWORD force_update_spectator_glow = 0x393362;
	const DWORD interface_engine_cvar = 0x3E9EC;
	const DWORD is_c4_owner = 0x39F5A0;
	const DWORD m_bDormant = 0xED;
	const DWORD m_pStudioHdr = 0x294C;
	const DWORD m_pitchClassPtr = 0x5139B10;
	const DWORD m_yawClassPtr = 0xCF81E8;
	const DWORD model_ambient_min = 0x58FD1C;
	const DWORD set_abs_angles = 0x1CA8B0;
	const DWORD set_abs_origin = 0x1CA6F0;
