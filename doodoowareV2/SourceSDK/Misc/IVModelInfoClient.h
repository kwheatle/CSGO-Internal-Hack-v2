...
#include "..\Math\Math.h"
#include "..\sdk.h"
#include "..\Misc\IVModelRender.h" //Has some structs we need here
...
public:
	inline void* GetModel(int Index) {
		return gInterface.CallVirtualFunction<void*(__thiscall *)(void*, int)>(this, 1)(this, Index);
	}
	int	GetModelIndex(const char *name)
	{
		typedef int(__thiscall* oGetModelName)(PVOID, const char *);
		return gInterface.CallVirtualFunction< oGetModelName >(this, 2)(this, name);
	}
	const char *GetModelName(const model_t *mod)
	{
		typedef const char *(__thiscall* oGetModelName)(PVOID, const model_t*);
		return gInterface.CallVirtualFunction< oGetModelName >(this, 3)(this, mod);
	}
	inline const char* GetModelName(const void* Model) {
		return gInterface.CallVirtualFunction<const char*(__thiscall *)(void*, const void*)>(this, 3)(this, Model);
	}
	studiohdr_t	*GetStudioModel(const model_t *mod)
	{
		typedef studiohdr_t *(__stdcall* oGetStudiomodel)(const model_t*);
		return gInterface.CallVirtualFunction< oGetStudiomodel >(this, 32)(mod);
	}
...
//gInterface.CallVirtualFunction
